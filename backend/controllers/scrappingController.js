...
export const scrappeChintGlobalWebsite = async (req, res) => {
  ...
  try {
    ...
    const data = await page.evaluate(() => {
      ...
      let information =
        document.querySelector(".chint-product-detail-info")?.innerHTML || "";
...
export const scrappeAbbWebsite = async (req, res) => {
  try {
    ...
    await page.waitForSelector("pis-products-details-attribute-groups", {
      timeout: 10000,
    });
    ...
    let data = await page.evaluate(() => {
      ...
      let descContainer = document.querySelector(
      ...
      let informationRoot = document.querySelector(
        "pis-products-details-attribute-groups"
      )?.shadowRoot;
      let information =
        informationRoot?.querySelector(
          ".pis-products-details-attribute-groups > div"
        )?.innerHTML || "";
...
export const scrappeSEWebsite = async (req, res) => {
  ...
  try {
    ...
    let data = await page.evaluate(() => {
      ...
      let description =
        secondRoot?.querySelector("div.range-info__description")?.textContent ||
        "";
